...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Fuzzy-Eigennamen-Korrektur: firmenspezifische Namen (z. B. „Muster GmbH“) werden bei Tippfehlern per Levenshtein-Distanz erkannt und vor der Suche korrigiert.",
