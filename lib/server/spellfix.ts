 ...
 *
 * Ordinary spellcheckers don't know instance-specific names ("Muster GmbH"), so a
 * mistyped proper noun ("Msuter GmbH") makes the whole search miss. This module
 ...
 * plain Levenshtein it counts an adjacent transposition ("Msuter"→"Muster") as a
...
export function correctProperNouns(
  ...
  // Multi-word names first: "Muster GmbH" should win over a lone "GmbH".
